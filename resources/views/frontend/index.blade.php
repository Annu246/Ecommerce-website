...
<head>
    <meta charset="utf-8">
    <title>Ecommerce Website-MultiShop </title>
...
<body>
    ...
    <div class="container-fluid">
        <div class="row bg-secondary py-1 px-xl-5">
            <div class="col-lg-6 d-none d-lg-block">
                <div class="d-inline-flex align-items-center h-100">
                    <p class="text-body mr-3" >Welcome to Ecommerce Website</p>
                ...
                <div class="d-inline-flex align-items-center">
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" type="button" href="{{ route('userlogin')}}">Sign in</a>
                            <a class="dropdown-item" type="button" href="{{ route('userregister')}}">Sign up</a>
                        </div>
                    </div>
        ...
        <div class="row align-items-center bg-light py-3 px-xl-5 d-none d-lg-flex">
            ...
            <div class="col-lg-4 col-6 text-right">
                ...
                <h5 class="m-0">+977-9823426578</h5>
            </div>
        </div>
    </div>
    <!-- Topbar End -->
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            <a href="{{ route('homes')}}" class="nav-item nav-link active">Home</a>
                        ...
                        <div class="carousel-item position-relative active" style="height: 430px;">
                            ...
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    ...
                                    <p class="mx-md-5 px-5 animate__animated animate__bounceIn"> Our Aim Is to Provide Best Quality Products<br> At Affordable Price.</p>
                        ...
                        <div class="carousel-item position-relative" style="height: 430px;">
                            ...
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    ...
                                    <p class="mx-md-5 px-5 animate__animated animate__bounceIn">Our Aim Is to Provide Best Quality Products<br> At Affordable Price.</p>
                                    <a class="btn btn-outline-light py-2 px-4 mt-3 animate__animated animate__fadeInUp" href="{{ route('userlogin') }}">Shop Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-4">
                <div class="product-offer mb-30" style="height: 200px;">
                    ...
                    <div class="offer-text">
                        ...
                        <a href="{{ route('userlogin') }}" class="btn btn-primary">Shop Now</a>
                    </div>
                </div>
                <div class="product-offer mb-30" style="height: 200px;">
                ...
                <a class="text-decoration-none" href="">
                   <div class="cat-item d-flex align-items-center mb-4">
                       ...
                       <div class="flex-fill pl-3">
                           ...
                           <small class="text-body">{{ $category->No_of_Products ?? "" }}</small>
                       </div>
    ...
    <div class="container-fluid pt-5 pb-3">
        ...
        <div class="row px-xl-5">
            ...
            @forelse($featured_products as $products)
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <div class="product-item bg-light mb-4">
                    ...
                    <div class="text-center py-4">
                        ...
                        <div class="d-flex align-items-center justify-content-center mt-2">
                            <h5>{{ $products->new_price ?? ""}}</h5><h6 class="text-muted ml-2"><del>{{ $products->old_price ?? ""}}</del></h6>
                        </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <div class="product-item bg-light mb-4">
                    ...
                    <div class="text-center py-4">
                        ...
                        <div class="d-flex align-items-center justify-content-center mt-2">
                            <h5>{{ $product->new_price ?? ""}}</h5><h6 class="text-muted ml-2"><del>{{ $product->old_price ?? ""}}</del></h6>
                        </div>
    ...
    <div class="container-fluid bg-dark text-secondary mt-5 pt-5">
        <div class="row px-xl-5 pt-5">
            <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
                ...
                <p class="mb-4">For any information and query you can contact us through our email and phone no. given below.</p>
                <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>Birgunj,Parsa,Nepal</p>
                <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>shah.annu@example.com</p>
                <p class="mb-0"><i class="fa fa-phone-alt text-primary mr-3"></i>+977-9829865687</p>
            </div>
                ...
                <div class="row">
                    <div class="col-md-4 mb-5">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            <a class="text-secondary mb-2" href="{{ route('homes')}}"><i class="fa fa-angle-right mr-2"></i>Home</a>
                    ...
                    <div class="col-md-4 mb-5">
                        ...
                        <p> Enter Your E-mail and Sign Up</p>
                        <form action="">
                            <div class="input-group">
                        ...
                        <div class="d-flex">
                            <a class="btn btn-primary btn-square mr-2" href="https://twitter.com/?lang=en"><i class="fab fa-twitter"></i></a>
