...
<head>
  ...
  <link href="{{ asset('frontend/assets/vendor/boxicons/css/boxicons.min.') }}" rel="stylesheet">
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form method="POST" action="{{ route('adminregistersave')}}" class="row g-3 needs-validation" novalidate>
                    @csrf
                    <div class="col-12">
